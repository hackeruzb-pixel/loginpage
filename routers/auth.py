from fastapi import APIRouter, HTTPException, status, Depends  # ✅ Depends qo‘shildi
...
def register_user(payload: RegisterRequest, db: Session = Depends(get_db)):  # ✅ Bu yer to'g'rilandi
